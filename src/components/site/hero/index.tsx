...
const Hero = (props: Props) => {
  ...
  const translatY = useTransform(scrollYProgress, [0, 1], [100, -150])

  return (
    <section
      ref={heroRef}
      className="pt-[160px] pb-20 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_100%)] overflow-x-clip"
    >
      <div className="container">
        <div className="md:flex items-center">
          <div className="md:w-[478px]">
            <div className="tag">Optimisez votre quotidien</div>
