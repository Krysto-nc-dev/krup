  ...
  const onSubmit = async (values: z.infer<typeof TicketFormSchema>) => {
    ...
    try {
      ...
      await saveActivityLogsNotification({
        agencyId: undefined,
        description: `Mise à jour d'un ticket | ${response?.name}`,
        subaccountId,
      })

      toast({
        title: 'Succès',
        description: 'Détails du ticket enregistrés',
      })
      ...
      toast({
        variant: 'destructive',
        title: 'Oups!',
        description: 'Impossible d\'enregistrer les détails du ticket',
      })
    }
    setClose()
  }
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Valeur du ticket</FormLabel>
                  <FormControl>
                    <Input
                      placeholder="Valeur"
                      {...field}
            ...
            />
            <FormLabel>Assigné à un membre de l'équipe</FormLabel>
            <Select
