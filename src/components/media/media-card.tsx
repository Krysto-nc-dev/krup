      ...
      <DropdownMenu>
        <article className="border w-full rounded-lg bg-slate-900">
          ...
          <DropdownMenuContent>
            ...
            >
              <Copy size={15} /> Copier le lien de l'image
            </DropdownMenuItem>
            <AlertDialogTrigger asChild>
              <DropdownMenuItem className="flex gap-2">
                <Trash size={15} /> Supprimer le fichier
              </DropdownMenuItem>
            </AlertDialogTrigger>
          </DropdownMenuContent>
        </article>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-left">
            Êtes-vous sûr de vouloir supprimer ce fichier ? Tous les sous-comptes utilisant ce fichier n'y auront plus accès !
          </AlertDialogDescription>
        </AlertDialogHeader>
          ...
          <AlertDialogAction
            ...
            onClick={async () => {
              ...
              await saveActivityLogsNotification({
                agencyId: undefined,
                description: `Fichier média supprimé | ${response?.name}`,
