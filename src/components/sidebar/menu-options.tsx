    ...
    >
      ...
      >
        <div>
                      ...
                      onClick={() => {
                        setOpen(
                          <CustomModal
                            ...
                            subheading="Vous pouvez basculer entre votre compte d'agence et le sous-compte depuis la barre latérale"
                          >
                            <SubAccountDetails
          ...
          <p className="text-muted-foreground text-xs mb-2">LIENS DE MENU</p>
